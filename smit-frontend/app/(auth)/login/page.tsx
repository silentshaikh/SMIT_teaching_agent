    ...
    <main className="min-h-screen bg-cyber-black flex items-center justify-center px-[var(--space-page-x)]">
      <div ref={containerRef} className="w-full max-w-md space-y-6">
        <div className="cyber-panel p-8">
          ...
          <h1 className="font-heading font-bold text-2xl uppercase tracking-[0.08em] bg-gradient-to-r from-cyber-green via-cyber-purple to-cyber-green bg-[length:200%_auto] animate-gradient-shift bg-clip-text text-transparent">
            Sign In
          </h1>
